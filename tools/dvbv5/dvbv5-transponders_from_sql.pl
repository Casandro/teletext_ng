...
my $get_transponders=$dbh->prepare("SELECT id, sat_number, delivery_system, lnb, frequency, polarization, symbol_rate, modulation, pilot, inner_fec, inversion, rolloff, stream_id FROM transponders WHERE weight>0 ORDER BY id");
